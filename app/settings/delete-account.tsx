...
/** Conséquences propres au compte livreur — l'équivalent DaloaMarket parle
 *  d'annonces et de boutique, ce qui n'a pas de sens ici. */
const CONSEQUENCES = [
  'Votre fiche sort de l’annuaire : nom, téléphone, photo et documents de vérification (CNI) sont effacés.',
  'Votre accès est révoqué définitivement : vous ne pourrez plus vous reconnecter.',
  'Vos courses déjà effectuées sont conservées sans votre identité : la loi impose de garder ces écritures, et elles font foi en cas de litige.',
  'Tout gain non encore retiré sera perdu : effectuez vos retraits avant de continuer.',
  'Cette action est irréversible.',
];

/**
 * Suppression du compte livreur.
 *
 * Écran obligatoire : Google Play (suppression des données) et Apple (5.1.1(v))
 * exigent que toute application permettant de créer un compte permette aussi de
 * le supprimer depuis l'application elle-même.
 */
export default function DeleteAccountScreen() {
  ...
  const handleDelete = () => {
    ...
    showAlert(
      ...
      'Votre compte livreur et toutes vos données seront supprimés. Cette action ne peut pas être annulée.',
      [
