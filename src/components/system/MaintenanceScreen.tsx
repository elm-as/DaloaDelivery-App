...
/** Écran plein affiché quand le mode maintenance est activé côté serveur pour DaloaDelivery. */
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + spacing[8], paddingBottom: insets.bottom }]}>
      ...
      <AppText variant="body" color={colors.text.muted} center style={styles.message}>
        {message || 'DaloaDelivery est temporairement en maintenance. Nos services reprennent très vite !'}
      </AppText>
